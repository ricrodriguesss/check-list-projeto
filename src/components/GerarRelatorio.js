  ...
  return (
    <div className="container">
      <aside className="sidebar">
        ...
        <a href="#" className="menu-item report-btn" onClick={handleGenerateReportClick}>Gerar Relatório</a>
        ...
        <section className="form-section">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <input type="text" id="responsavelOperacional" name="responsavelOperacional" required />
            </div>
            <div className="form-group">
              <label htmlFor="consultorTecnico">Consultor Técnico:</label>
              <input type="text" id="consultorTecnico" name="consultorTecnico" required />
            </div>
            <div className="action-buttons">
              <button className="form-button" type="submit">Iniciar</button>
            </div>
          </form>
        </section>
      </main>
